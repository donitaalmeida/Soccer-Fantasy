...
@media (min-width: 480px) {
  ...
  <body >
    ...
    try {
      ...
      $query1 ="Select club.club_name, club.club_manager, sum(total_goals) as
'goals'
...
order by sum(total_goals) desc limit 10";
      $query2="Select  club.club_name, club.club_manager,  sum(games_won) as 'games_won'
from club, league, club_stats
where club.club_key = club_stats.club_key and league.league_key =
club_stats.league_key and league.league_name = 'Laliga'
group by club.club_key
order by games_won desc limit 10";
    ...
    $query3="Select  club.club_name, club.club_manager,  sum(games_won) as 'games_won'
from club, league, club_stats
where club.club_key = club_stats.club_key and league.league_key =
club_stats.league_key and league.league_name = 'Laliga'
group by club.club_key
